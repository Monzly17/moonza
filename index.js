...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *🌀VLYZANBOT🌀* , Follow Instagram Mimin Yah😻 : https://instagram.com/@fdy_moonza' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *🌀VLYZANBOT🌀* , Follow Instagram Mimin Yah😻 : https://instagram.com/@fdy_moonza' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah VlyzanBot
